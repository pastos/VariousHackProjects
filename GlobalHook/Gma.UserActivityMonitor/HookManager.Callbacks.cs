    ...
    public static partial class HookManager
    {
        ...
        private static int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            if (nCode >= 0)
            {
                ...
                if (s_MouseUpExt != null && mouseUp)
                {
                    s_MouseUpExt.Invoke(null, e);
                }
                ...
                if(s_MouseDownExt !=null && mouseDown)
                {
                    s_MouseDownExt.Invoke(null, e);
                }
                ...
                if (s_MouseWheelExt != null && mouseDelta != 0)
                {
                    s_MouseWheelExt.Invoke(null, e);
                }
