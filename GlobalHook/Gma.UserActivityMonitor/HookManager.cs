...
namespace InputActivityMonitor
{
    ...
    public static partial class HookManager
    {
        ...
        private static event EventHandler<MouseEventExtArgs> s_MouseDownExt;

        /// <summary>
        /// Occurs when a mouse down was performed by the mouse. 
        /// </summary>
        /// <remarks>
        /// This event provides extended arguments of type <see cref="MouseEventArgs"/> enabling you to 
        /// supress further processing of mouse down in other applications.
        /// </remarks>
        public static event EventHandler<MouseEventExtArgs> MouseDownExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
                s_MouseDownExt += value;
            }
            remove
            {
                s_MouseDownExt -= value;
        ...
        private static event EventHandler<MouseEventExtArgs> s_MouseUpExt;

        /// <summary>
        /// Occurs when a mouse up was performed by the mouse. 
        /// </summary>
        /// <remarks>
        /// This event provides extended arguments of type <see cref="MouseEventArgs"/> enabling you to 
        /// supress further processing of mouse up in other applications.
        /// </remarks>
        public static event EventHandler<MouseEventExtArgs> MouseUpExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        private static event EventHandler<MouseEventExtArgs> s_MouseWheelExt; 

        /// <summary>
        /// Occurs when the mouse wheel moves. 
        /// </summary>
        public static event EventHandler<MouseEventExtArgs> MouseWheelExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
                s_MouseWheelExt += value;
            }
            remove
            {
                s_MouseWheelExt -= value;
