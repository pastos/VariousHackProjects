...
namespace InputActivityMonitor
{
    public static partial class HookManager
    {
        ...
        /// <summary>
        /// The X_BUTTONDOWN message is posted when the user presses any mouse X button.
        /// </summary>
        private const int X_BUTTONDOWN = 0x020B;

        /// <summary>
        /// The X_BUTTONUP message is posted when the user presses any mouse X button.
        /// </summary>
        private const int X_BUTTONUP = 0x020C;
        ...
        //from https://stackoverflow.com/questions/17897646/setwindowshookex-fails-with-error-126 and http://www.pinvoke.net/default.aspx/kernel32/LoadLibrary.html
