...
{
    public static class VK_Codes
    {

        //[DllImport("user32.dll")]
        //static extern uint MapVirtualKeyEx(uint uCode, uint uMapType, IntPtr dwhkl);

        //public uint ConvertToVKCode(uint code)
        //{
        //    MapVirtualKeyEx(code, MapVirtualKeyMapTypes.MAPVK_VSC_TO_VK, 0);
        //}
        ...
        ////const int VK_Key0 0x3A-40 	Undefined
        ...
        ////const int - 	=0xC1; //-D7 	Reserved
        ////const int - 	=0xD8; //-DA 	Unassigned
